...
Affordable_Housing_10_14 <- read.csv("HAI_map_2010-14.csv")  %>%
  dplyr::rename('per100_2014' = 'per100') %>%
  dplyr::rename('units_2014' = 'units')

Affordable_Housing_05_09 <- read.csv("HAI_map_2005-09.csv")  %>%
  dplyr::rename('per100_2009' = 'per100') %>%
  dplyr::rename('units_2009' = 'units')
...
Affordable_Housing <- full_join(Affordable_Housing_05_09, Affordable_Housing_10_14, by = c('countyname' = 'countyname', 'State_Name' = 'State_Name')) %>%
  ...
  select(countyname, countyname2, State_Name, per100_2014, per100_2009, units_2009, units_2014)
```
...
Affordable_Housing_Oregon <- Affordable_Housing_Oregon %>%
  group_by(Area) %>%
  dplyr::summarise(units_2014 = mean(units_2014), per100_2014 = mean(per100_2014), units_2009 = mean(units_2009), per100_2009 = mean(per100_2009)) # also must specify dplyr
...
```{r}
ggplot(PIT_Housing_Oregon_Merge, aes(x = Unsheltered_2017, y = per100_2014, label = Area)) +
  geom_point()+
  geom_text()
...
Affordable_Housing_State <- Affordable_Housing %>%
  group_by(State_Name) %>%
  dplyr::summarise(units_2014 = mean(units_2014, na.rm = TRUE), per100_2014 = mean(per100_2014, na.rm = TRUE), units_2009 = mean(units_2009, na.rm = TRUE), per100_2009 = mean(per100_2009, na.rm = TRUE))
...
ggplot(PIT_Housing_State_Merge, aes(y = as.numeric(Change_2009), x = per100_2009)) +
  geom_point() + 
